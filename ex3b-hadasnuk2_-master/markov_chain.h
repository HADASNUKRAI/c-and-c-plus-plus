...
typedef void (*print_func_1)(const void*);
typedef int (*comp_func_1)(const void*, const void*);
typedef void (*free_data_1)(void*);
typedef void* (*copy_func_1)(const void*);
typedef bool (*is_last_1)(const void*);
...
typedef struct MarkovNodeFrequency {
    MarkovNode *word; //The following word
    int frequency;
} MarkovNodeFrequency;
